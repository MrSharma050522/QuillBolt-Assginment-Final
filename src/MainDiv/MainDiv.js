...
export default function MainDiv() {
  ...
  return (
    <div className="mt-5 mb-5 d-flex justify-content-around align-items-center col-7">
      <div style={{ height: "300px" }} className="col-7">
        <img src={images[ind]} />
      </div>
      <div className="col-5">
        {dummyData.map((el, i) => {
          return (
            <div style={{ textAlign: "inline-start" }} key={i}>
